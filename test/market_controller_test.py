...
register_market_listing(game_data=game_data, market_id=market_id, seller_fe_id=urer_b, product_id=apple, amount=100,
                        price_per_unit=50)
...
print(u_a_fe.wallet)
print(u_b_fe.wallet)
print(purchase_by_category(game_data=game_data, buyer_fe_id=urer_a, category=0, amount_required=50, market_id=market_id,
