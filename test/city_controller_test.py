...
print("market_purchase test")
print("TestFailed budget b-in")
print("before")
print(u_a_fe.wallet)
print(u_b_fe.wallet)
market_purchase(game_data=game_data, buyer_fe_id=urer_b, products={apple: 100}, market_id=market_id, budget=1)
print("after")
print(u_a_fe.wallet)
print(u_b_fe.wallet)
...
print(u_a_fe.wallet)
print(u_b_fe.wallet)
market_purchase(game_data=game_data, buyer_fe_id=urer_b, products={apple: 100}, market_id=market_id, budget=100)
print("after")
print(u_a_fe.wallet)
print(u_b_fe.wallet)
...
print(u_a_fe.wallet)
print(u_b_fe.wallet)
market_purchase(game_data=game_data, buyer_fe_id=urer_a, products={apple: 10}, market_id=market_id, budget=50000)
print("after")
print(u_a_fe.wallet)
print(u_b_fe.wallet)
...
print(u_a_fe.wallet)
print(u_b_fe.wallet)
market_purchase(game_data=game_data, buyer_fe_id=urer_a, products={apple: 500}, market_id=market_id, budget=50000)
print("after")
print(u_a_fe.wallet)
print(u_b_fe.wallet)
